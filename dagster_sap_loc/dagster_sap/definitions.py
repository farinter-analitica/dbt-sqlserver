...
from .assets import dbt_dwh_sap_mart_datos_maestros, dbt_dwh_sap_mart_finanzas
...
all_assets =  dbt_dwh_sap_mart_datos_maestros_assets + dbt_dwh_sap_mart_finanzas_assets #+
