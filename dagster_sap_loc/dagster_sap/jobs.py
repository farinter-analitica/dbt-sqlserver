...
sap_etl_dwh_hourly_all_downstream_assets: AssetSelection = AssetSelection.assets(*sap_etl_dwh_hourly_asset_keys).downstream() | AssetSelection.groups("sap_etl_dwh").tag(key="replicas_sap", value="true")
