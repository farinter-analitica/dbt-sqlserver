{%- set unique_key_list = ["Fecha_Id", "Articulo_Id", "Vendedor_Id", "Suc_Id", "Emp_Id"] -%}
...
WITH BaseFacturaAsegurada AS (
    SELECT
        ...
        ISNULL(FP.Vendedor_Id, 0) AS Vendedor_Id,
    ...
    GROUP BY CAST(FP.Factura_Fecha AS DATE), FP.Articulo_Id, FP.Vendedor_Id, FP.Suc_Id, FP.Emp_Id
)
