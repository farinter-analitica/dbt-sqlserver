...
SELECT
    *,
    ABS(CAST(CAST(HASHBYTES('SHA2_256', CONCAT(SubCategoria3Art_Id, '-', SubCategoria2Art_Id, '-', SubCategoria1Art_Id, '-', CategoriaArt_Id, '-', Emp_Id)) AS INT) AS BIGINT))
        AS Hash_CatSubCat1_2_3Emp,
