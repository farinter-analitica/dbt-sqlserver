...
(
    SELECT 
        ...
        ISNULL(SUM(FP.Descuento_Proveedor),0.0)*1.0 AS Sum_Descuento_Proveedor,
...
ResumenFinal AS (
    SELECT 
        ...
        ISNULL(SUM(FP.Sum_Descuento_Proveedor),0.0)*1.0 AS Sum_Descuento_Proveedor,
    ...
    SELECT 
        ...
        TRY_CAST(Sum_Descuento_Proveedor / (DATEDIFF(HOUR, Min_Hora_Dia, Max_Hora_Dia) + 1.0) AS DECIMAL(16,6)) AS Prom_Valor_Descuento_Proveedor,
        ...
        TRY_CAST(Sum_Descuento_Proveedor / NULLIF(SUM(Sum_Descuento_Proveedor) OVER(PARTITION BY Emp_Id, Suc_Id, Factura_Fecha),0) AS DECIMAL(16,12)) AS Part_Valor_Descuento_Proveedor,
