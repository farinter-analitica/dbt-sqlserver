...
(
    SELECT --TOP (1000) 
        ...
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Cantidad_Padre ELSE PR.Prom_Cantidad_Padre END)
            *ISNULL(PDS.Part_Cantidad_Padre*7,1)*ISNULL(PDSH.Part_Cantidad_Padre,1)  AS DECIMAL(16,6)) AS Cantidad_Padre,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Bruto ELSE PR.Prom_Valor_Bruto END)
            *ISNULL(PDS.Part_Valor_Bruto*7,1)*ISNULL(PDSH.Part_Valor_Bruto,1)  AS DECIMAL(16,6)) AS Valor_Bruto,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Neto ELSE PR.Prom_Valor_Neto END)
            *ISNULL(PDS.Part_Valor_Neto*7,1)*ISNULL(PDSH.Part_Valor_Neto,1)  AS DECIMAL(16,6)) AS Valor_Neto,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Costo ELSE PR.Prom_Valor_Costo END)
            *ISNULL(PDS.Part_Valor_Costo*7,1)*ISNULL(PDSH.Part_Valor_Costo,1)  AS DECIMAL(16,6)) AS Valor_Costo,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Descuento ELSE PR.Prom_Valor_Descuento END)
            *ISNULL(PDS.Part_Valor_Descuento*7,1)*ISNULL(PDSH.Part_Valor_Descuento,1)  AS DECIMAL(16,6)) AS Valor_Descuento,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Descuento_Financiero ELSE PR.Prom_Valor_Descuento_Financiero END)
            *ISNULL(PDS.Part_Valor_Descuento_Financiero*7,1)*ISNULL(PDSH.Part_Valor_Descuento_Financiero,1)  AS DECIMAL(16,6)) AS Valor_Descuento_Financiero,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Acum_Monedero ELSE PR.Prom_Valor_Acum_Monedero END)
            *ISNULL(PDS.Part_Valor_Acum_Monedero*7,1)*ISNULL(PDSH.Part_Valor_Descuento_Financiero,1)   AS DECIMAL(16,6)) AS Valor_Acum_Monedero,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Descuento_Cupon ELSE PR.Prom_Valor_Descuento_Cupon END)
            *ISNULL(PDS.Part_Valor_Descuento_Cupon*7,1)*ISNULL(PDSH.Part_Valor_Descuento_Cupon,1)  AS DECIMAL(16,6)) AS Valor_Descuento_Cupon,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Descuento_Proveedor ELSE PR.Prom_Valor_Descuento_Proveedor END)
            *ISNULL(PDS.Part_Valor_Descuento_Proveedor*7,1)*ISNULL(PDSH.Part_Valor_Descuento_Proveedor,1)   AS DECIMAL(16,6)) AS Valor_Descuento_Proveedor,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Valor_Descuento_Tercera_Edad ELSE PR.Prom_Valor_Descuento_Tercera_Edad END)
            *ISNULL(PDS.Part_Valor_Descuento_Tercera_Edad*7,1)*ISNULL(PDSH.Part_Valor_Descuento_Tercera_Edad,1)    AS DECIMAL(16,6)) AS Valor_Descuento_Tercera_Edad,
        CAST((CASE WHEN CAL.Es_Dia_Feriado = 1 THEN PFER.Prom_Conteo_Transacciones ELSE PR.Prom_Conteo_Transacciones END)
            *ISNULL(PDS.Part_Conteo_Transacciones*7,1)*ISNULL(PDSH.Part_Conteo_Transacciones,1)   AS DECIMAL(16,6)) AS Conteo_Transacciones
