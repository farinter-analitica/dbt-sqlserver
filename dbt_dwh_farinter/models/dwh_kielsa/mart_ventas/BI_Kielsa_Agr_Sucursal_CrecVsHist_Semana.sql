...
(
    SELECT 
        ...
        SUM(Sum_Descuento_Proveedor) / SUM(Anios_Muestra)*SUM(Semanas_Muestra) AS Prom_Valor_Descuento_Proveedor,
...
(
    SELECT 
        ...
        SUM(Sum_Descuento_Proveedor) / SUM(Semanas_Muestra) AS Prom_Valor_Descuento_Proveedor,
