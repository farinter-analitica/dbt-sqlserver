...
sap_dbt_etl_dwh_hourly_asset_keys = [AssetKey(["DL_FARINTER","dbo",Asset]) for Asset in ["DL_SAP_MARC","DL_SAP_MARD","DL_SAP_MARA","DL_SAP_MCHB","DL_SAP_MCH1","DL_SAP_MBEW","DL_SAP_MCHA"]]
