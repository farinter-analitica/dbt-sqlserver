...
class TestReplicasLdcomStatus:
    ...
    def setup_mocks(self, mocker):
        ...
        self.mock_send_email = mocker.patch.object(
            EmailSenderResource, "send_email", return_value=None
        )
    ...
    def test_replicas_ldcom_status(self, email_sender_resource):
        ...
        self.mock_get_max_column_value.assert_any_call(
            "server_a", "example_db", "example_table", "example_column"
        )
        self.mock_get_max_column_value.assert_any_call(
            "server_b", "example_db", "example_table", "example_column"
        )
