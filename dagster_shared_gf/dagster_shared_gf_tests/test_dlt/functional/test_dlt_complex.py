...
@dlt.source(name="variants_tests", parallelized=True, root_key=True)
...
def test_second_load_dwh():
    json_source_data = [
        ...
        # Document 2 ( nested 'address double')
        {
            ...
            "address": [
                {"city": "Atlantis", "zip": "77777"},
                {"city": "Gotham", "zip": "12345"},
            ],
        },
        ...
        # Document 6
        {
            "id": 6,
            "name": "Frank",
            "preferences": {"colors": ["red"], "music": ["jazz"]},
        },
        # Document 7
        {
            "id": 7,
        ...
        # Document 20, more complex nested data in 'preferences' with data type changed.
        {
            ...
            "extra_info": {
                ...
                "notes": "Frequent flyer",
                "insider_extra_table": [
                    {"loyalty_points": 100, "no": 1},
                    {"loyalty_points": 200, "no": 2},
                ],
            },
        },
    ]
