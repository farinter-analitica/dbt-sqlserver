...
def wait_if_job_running_to_execute_next_job():
    ...
    wait_if_job_running_to_execute_next_op(current_location_name=dagster_kielsa_gf.__name__)
...
defs = Definitions(assets=all_ops, jobs=all_jobs, schedules=all_schedules)
