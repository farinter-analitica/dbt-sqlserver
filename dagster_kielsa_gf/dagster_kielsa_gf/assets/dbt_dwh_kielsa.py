from dagster import AssetExecutionContext, load_assets_from_current_module, load_asset_checks_from_current_module, build_last_update_freshness_checks, AssetChecksDefinition
...
@dbt_assets(manifest=dbt_manifest_path, select="tag:dagster_kielsa_gf")
